...
<html lang="en">
	...
	<body>
			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						<li class="active">
							<a href="${pageContext.request.contextPath}/forwardHead.action" target="content">
						...
						<li>
							...
							<ul class="submenu">
								...
								<li>
									<a href="${pageContext.request.contextPath}/forward.action" target="content">
										<i class="icon-double-angle-right"></i>
										新建店铺
									</a>
								</li>
				...
				<div class="main-content">
					<iframe id="content" name="content" onload="Javascript:SetWinHeight(this)" frameborder="0" scrolling="no" width="100%"></iframe>
				</div><!-- /.main-content -->
		...
		<script type="text/javascript" src="<%=path%>/extrajs/manager.js"></script>
